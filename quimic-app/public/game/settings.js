...
function drawSettingsMenu() {
    ...
    let settingsText = this.add.text(screenWidth / 6, screenHeight - (screenHeight* 0.85), 'Ajustes', { fontFamily: 'pixel_nums', fontSize: (screenWidth / 45), align: 'center'});
    ...
    let sliderDotText = this.add.text(screenWidth / 5.15, screenHeight / 1.85, 'Volumen General', { fontFamily: 'pixel_nums', fontSize: (screenWidth / 60), align: 'center'}).setOrigin(0.5, 0);
